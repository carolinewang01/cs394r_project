...
from examples.atari_wrapper import wrap_deepmind
...
def get_args():
    ...
    parser.add_argument('--task', type=str, default='CoinChoice-v0')
...
def test_iqn(args=get_args()):
    ...
    args.state_shape = (1,)+args.state_shape+(1,)
    ...
    def watch():
        ...
        if args.save_buffer_name:
            ...
            result = test_collector.collect(
                n_episode=1000, render=args.render
            )
