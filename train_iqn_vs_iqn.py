...
def get_agents(
    ...
    if args.agent_id == 1:
        ...
        policies_to_learn = {agent_labels[0]: True, agent_labels[1]: True}
...
def train_agent(
    ...
    # log
    log_path = os.path.join(args.logdir, args.env_id, f'{args.agent_learn_algo}-vs-{args.opponent_learn_algo}_trial={args.trial_idx}_opponent-eta={args.eta}+{args.opponent_eta}_opponent-risk-distort={args.risk_distortion}')
    ...
    def save_best_fn(policy):
        if hasattr(args, 'model_save_path'):
            ...
            model_save_path = os.path.join(
                args.logdir, args.env_id, f'{args.agent_learn_algo}-vs-{args.opponent_learn_algo}_trial={args.trial_idx}_opponent-eta={args.eta}+{args.opponent_eta}_opponent-risk-distort={args.risk_distortion}', 'policy.pth')
        torch.save(
